...
const RESET_DEF = [
  ...
  { key: "link", configKey: "reset_link_entity", defaultEntity: "button.somfy_protexial_reinitialiser_defaut_liaison_radio", icon: "mdi:access-point-refresh", text: "resetLink" },
];
